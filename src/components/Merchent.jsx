...
hover:shadow-lg hover:-translate-y-1 transform transition-all duration-300">
				...
				{/* User Info */}
				<div className="flex-1 bg-white rounded-xl shadow-lg border border-BLACK-100 hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300 overflow-hidden">
					{/* CURVED HEADER: Uses rounded-b-full for a deep arc effect, contained by parent's overflow-hidden */}
					<div className="relative bg-blue-600 pb-10 mb-10 rounded-b-full">
						<h1 className="text-xl font-bold text-white text-center pt-6">
							Welcome Back, John Doe
						</h1>
					</div>

					<div className="px-6 pb-6 pt-0">
						<p className="text-gray-700 mb-2"><span className="font-semibold text-blue-600">Email:</span> example@example.com</p>
						<p className="text-gray-700 mb-2"><span className="font-semibold text-blue-600">Entity Type:</span> Individual</p>
						<p className="text-gray-700"><span className="font-semibold text-blue-600">Contact:</span> +123456789</p>
					</div>
				</div>
				{/* Services */}
