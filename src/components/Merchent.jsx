...
hover:shadow-md hover:-translate-y-1 transform transition-all duration-300">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Service 1 */}
            <div
              className="flex flex-col items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-all shadow-sm hover:shadow-lg hover:-translate-y-1 transform duration-300 cursor-pointer"
