...
const AddScheme = ({ operation }) => {
  ...
  const { data: postData, execute } = usePost("/create-scheme");
  ...
  const handleSubmit = async () => {
    ...
    const body = {
      ...
      merchent_id: selectedMerchentIds,
      blr_id: selectedBillerIds,
    };
